 ...
 function createQuestion( ) {
     ...
     if ( questionSurvey == 6 ) {
         ...
         if ( i < 2 && questionSurvey == 2 ) {
             swal( {
                 title: "Opción Múltiple sencilla",
         ...
         if ( i < 3 && questionSurvey == 4 ) {
             swal( {
                 title: "Opción Múltiple respuesta múltiple",
 ...
 function borradoOpciones( ) {
     ...
     var b1 = "#b1";
     var newIn = '<input autocomplete="off" class="input" maxlength="100" id="field1' +
                 ...
                 for ( x = 0; x < q.length; x++ ) {
                     try {
                         ...
                         if ( n ) {
                             ...
                             next = next + 1;
                             var newIn = '<input autocomplete="off" class="input" maxlength="100" id="field' +
                                 next +
                                 '" name="field' +
                                 next +
                                 '" placeholder="Escribe respuesta " type="text" data-items="8">';
 ...
 function deleteQuestion( questionNumber ) {
     ...
     var table = $( '#datatable-buttons' ).DataTable( );
     table.row( $( '#question-' + questionNumber ).parents( 'tr' ) ).remove( ).draw( );
 }
                             ...
                             function( data ) {
                                 console
                                     .log( "updateEntity productEntityForm: " +
                                         JSON
                                         .stringify( data ) );
                                 if ( data.responseCode == "0000" ) window.location.replace( "/TPSUserPortal/sec/surveylist" );
                                 else continueToList( data.responseMessage );
                             } ).fail( function( ) {
                             continueToList( );
                         } );
                 } else {
 ...
 $( '#report' ).click( function( e ) {
     ...
     if ( an > 0 ) {
         ...
         window.location.href = 'http://50.112.46.215:9080/TPSUserServices/search/csv/survey?surveyId=' + $( "#idSurvey" ).val( );
     } else {
         swal( {
 ...
 $( document )
     .ready(
         function( ) {
             ...
             if ( $( '#datepicker-autoclose' ).val( ) == "" ) $( '#datepicker-autoclose' ).val( today );
             ...
             jQuery( '#datepicker' ).change(
                 function( ) {
                     var startD = $( '#datepicker' ).datepicker( 'getDate' );
                     var endDat = $( '#datepicker-autoclose' ).datepicker( 'getDate' );
                     var a = moment( startD, 'DD/MM/YYYY' );
                     var b = moment( endDat, 'DD/MM/YYYY' );
                     if ( b.isBefore( a ) ) {
                         console.log( "on change startDate: ", $( '#datepicker' ).val( ) );
                         $( '#datepicker-autoclose' ).val( $( '#datepicker' ).val( ) );
                         $( '#datepicker-autoclose' ).datepicker( "setDate", a.toDate( ) );
                         return false;
                     }
                 } );
             ...
             jQuery( '#datepicker-autoclose' ).change(
                 function( ) {
                     ...
                     var b = moment( endDat, 'DD/MM/YYYY' );
                     if ( b.isBefore( a ) ) {
                         console.log( "on change endDate: ", $( '#datepicker-autoclose' ).val( ) );
                         $( '#datepicker' ).val( $( '#datepicker-autoclose' ).val( ) );
                         $( '#datepicker' ).datepicker( "setDate", b.toDate( ) );
                         return false;
                     }
                 } );
             $( "#branches" ).select2( );
                 ...
                 .click(
                     function( e ) {
                         ...
                         if ( data == "" ) {
                             ...
                             $( addto1 ).attr( "placeholder", "Campo Requerido" );
                             return false;
                         } else {
                             $( addto1 ).css( {
                             ...
                             var addRemove = "#field" + ( next );
                             next = next + 1;
                             var newIn = '<input autocomplete="off" maxlength="100" class="input" id="field' +
                                 next +
                                 '" name="field' +
                                 next +
